...
int main(int argc, char** argv) {
    ...
    /*
    How to tune params:
    MOVE_DISTANCE: The distance between the end effector and the virtual attractor in the axis of pull but not the rotation, keep negative as it is a pull, increase absolute value for a greater force, decrease for lesser force
    ...
    */
    ...
    // Changed to be set frequency
    double LOOPS_BETWEEN_STATES = 1 / (DT * WIGGLE_RATE * STATES);
