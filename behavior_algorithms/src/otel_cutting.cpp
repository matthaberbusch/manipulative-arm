...
int main(int argc, char** argv) {
    ...
    ros::init(argc,argv,"otel_cutting");
    ros::NodeHandle nh;
    ...
    *///                                                                      was  0.1
    ...
    nh.param("/otel_cutting/target_orientation", TARGET_ORIENTATION, 1.57);
    
    // clear parameter from server 
    nh.deleteParam("/otel_cutting/target_orientation"); 
